...
CREATE TABLE `storeInfo` (
  ...
  `store_owner_info` json NOT NULL,
  `store_domain` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_store_name` (`store_name`),
  UNIQUE KEY `unique_store_domain` (`store_domain`)
...
INSERT INTO `storeInfo` VALUES (1,'PatelElectronics','{\"name\": \"jethalal gadha\"}','www.gadaElectronics.mystore.io');
...
-- Dump completed on 2024-09-22 22:47:22
